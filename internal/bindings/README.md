...
This package provides automatic TypeScript client generation for Soroban smart contracts with built-in Glassbox simulation support.
...
- **Glassbox Integration**: Built-in simulation and debugging capabilities
...
├── Glassbox-integration.ts   # Simulator
├── index.ts              # Exports
...
### 4. Generate Glassbox Integration
...
Glassbox generate-bindings target/wasm32-unknown-unknown/release/contract.wasm
```
