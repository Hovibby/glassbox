...
func (g *Generator) generateClient() string {
	...
	b.WriteString("    \n")
	b.WriteString("    // Initialize Glassbox simulator if enabled\n")
...
func (g *Generator) generateClientMethod(b *strings.Builder, fn xdr.ScSpecFunctionV0) {
	...
	// Simulation with Glassbox
	b.WriteString("    // Simulate with Glassbox if enabled\n")
...
// generateErstIntegration generates the Glassbox simulator integration
func (g *Generator) generateErstIntegration() string {
	...
	b.WriteString("    const erstPath = this.config.erstPath || 'glassbox';\n")
	b.WriteString("    \n")
	...
	b.WriteString("      const Glassbox = spawn(erstPath, args);\n")
	b.WriteString("      let stdout = '';\n")
	b.WriteString("      let stderr = '';\n\n")

	b.WriteString("      Glassbox.stdin.write(envelopeXdr);\n")
	b.WriteString("      Glassbox.stdin.end();\n\n")

	b.WriteString("      Glassbox.stdout.on('data', (data) => {\n")
	b.WriteString("        stdout += data.toString();\n")
	b.WriteString("      });\n\n")

	b.WriteString("      Glassbox.stderr.on('data', (data) => {\n")
	b.WriteString("        stderr += data.toString();\n")
	b.WriteString("      });\n\n")

	b.WriteString("      Glassbox.on('close', (code) => {\n")
	b.WriteString("        if (code !== 0) {\n")
	b.WriteString("          reject(new Error(`Glassbox exited with code ${code}: ${stderr}`));\n")
	b.WriteString("          return;\n")
	b.WriteString("        }\n\n")
	...
	b.WriteString("          reject(new Error(`Failed to parse Glassbox output: ${err}`));\n")
	b.WriteString("        }\n")
	b.WriteString("      });\n")
	b.WriteString("    });\n")
	b.WriteString("  }\n\n")
...
func (g *Generator) generateReadme() string {
	...
	fmt.Fprintf(&b, "# %s\n\n", g.config.PackageName)
	b.WriteString("TypeScript bindings for Soroban smart contract, generated by `Glassbox generate-bindings`.\n\n")
	...
	b.WriteString("  enableSimulation: true, // Enable Glassbox simulation\n")
	b.WriteString("});\n\n")
	...
	b.WriteString("- **Glassbox integration**: Built-in simulation and debugging with Glassbox\n")
	...
	b.WriteString("## Debugging with Glassbox\n\n")
	b.WriteString("```typescript\n")
