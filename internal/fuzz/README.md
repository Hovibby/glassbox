...
import (
	...
	"github.com/dotandev/glassbox/internal/fuzz"
...
./Glassbox fuzz --contract <contract-id> --iterations 10000 --timeout 5000

# Generate test report
./Glassbox fuzz --contract <contract-id> --report coverage.html
```
