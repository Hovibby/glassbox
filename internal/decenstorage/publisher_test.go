...
func TestNew_DefaultsApplied(t *testing.T) {
	t.Setenv("GLASSBOX_IPFS_NODE", "")
	t.Setenv("GLASSBOX_ARWEAVE_GATEWAY", "")
...
func TestNew_EnvOverrides(t *testing.T) {
	t.Setenv("GLASSBOX_IPFS_NODE", "http://custom-ipfs:5001")
	t.Setenv("GLASSBOX_ARWEAVE_GATEWAY", "http://custom-arweave")
