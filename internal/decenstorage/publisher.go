...
//     configurable via PublishConfig.IPFSNode or the GLASSBOX_IPFS_NODE
...
//     configurable via PublishConfig or the GLASSBOX_ARWEAVE_WALLET /
//     GLASSBOX_ARWEAVE_GATEWAY environment variables.
//
...
const (
	...
	envIPFSNode       = "GLASSBOX_IPFS_NODE"
	envArweaveGateway = "GLASSBOX_ARWEAVE_GATEWAY"
	envArweaveWallet  = "GLASSBOX_ARWEAVE_WALLET"
)
