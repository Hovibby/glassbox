...
Examples:
  ...
  Glassbox snapshot-diff --snapshot-a before.json --snapshot-b after.json

  # Compare a specific memory region
  Glassbox snapshot-diff --snapshot-a before.json --snapshot-b after.json --offset 0x100 --length 256
