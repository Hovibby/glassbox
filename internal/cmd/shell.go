...
import (
	...
	"github.com/dotandev/glassbox/internal/shell"
...
Examples:
  Glassbox shell                                    Start shell with empty state
  Glassbox shell --network testnet                  Start shell on testnet
  Glassbox shell --init-state snapshot.json         Start with initial state
...
func printWelcome() {
	fmt.Println("╔═══════════════════════════════════════════════════════════════╗")
	fmt.Println("║  Glassbox Interactive Shell                                       ║")
