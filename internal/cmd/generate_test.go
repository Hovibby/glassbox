...
import (
	...
	"github.com/dotandev/glassbox/internal/testgen"
...
Example:
  Glassbox generate-test 5c0a1234567890abcdef1234567890abcdef1234567890abcdef1234567890ab
  Glassbox generate-test --lang go --name my_test <tx-hash>`,
...
func init() {
	...
	generateTestCmd.Flags().StringVar(&rpcTokenFlag, "rpc-token", "", "RPC authentication token (can also use GLASSBOX_RPC_TOKEN env var)")
