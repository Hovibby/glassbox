...
```go
import "github.com/dotandev/glassbox/internal/decoder"
...
The decoder is integrated into the `Glassbox debug` command to automatically display human-readable errors:

```bash
$ Glassbox debug abc123...def789
...
```
PASS
ok      github.com/dotandev/glassbox/internal/decoder    0.123s
```
