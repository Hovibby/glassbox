...
describe('ProtocolHandler', () => {
    ...
    describe('rate limiting', () => {
        it('should allow requests within the defined rate limit', async () => {
            const uri1 = 'glassbox://debug/a1b2c3d4e5f67890123456789abcdef0123456789abcdef0123456789abcdeff?network=testnet&source=dashboard';
            const uri2 = 'glassbox://debug/b2c3d4e5f67890123456789abcdef0123456789abcdef0123456789abcdeffaa?network=testnet&source=dashboard';
        ...
        it('should reject requests that exceed the rate limit', async () => {
            const uri = 'glassbox://debug/a1b2c3d4e5f67890123456789abcdef0123456789abcdef0123456789abcdeff?network=testnet&source=dashboard';
    ...
    describe('origin validation', () => {
        ...
        it('should reject requests from untrusted origins', async () => {
            const uri = 'glassbox://debug/a1b2c3d4e5f67890123456789abcdef0123456789abcdef0123456789abcdeff?network=testnet&source=malicious-site';
