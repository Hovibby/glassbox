...
describe('Pkcs11Signer', () => {
  ...
  describe('constructor validation', () => {
    test('should throw clear error when GLASSBOX_PKCS11_MODULE is not set', () => {
    ...
    test('should throw clear error when GLASSBOX_PKCS11_PIN is not set', () => {
  ...
  describe('public_key', () => {
    test('should return public key from environment when set', async () => {
      ...
      process.env.GLASSBOX_PKCS11_PIN = '1234';
      process.env.GLASSBOX_PKCS11_KEY_LABEL = 'test-key';
      process.env.GLASSBOX_PKCS11_PUBLIC_KEY_PEM = '-----BEGIN PUBLIC KEY-----\ntest\n-----END PUBLIC KEY-----';
