...
Running benchmark...
  ...
  // Then set: export GLASSBOX_AUDIT_PRIVATE_KEY_PEM='<generated-key>'
  const testPrivateKeyPem = process.env.GLASSBOX_AUDIT_PRIVATE_KEY_PEM || (() => {
    throw new Error(
      'GLASSBOX_AUDIT_PRIVATE_KEY_PEM environment variable not set. ' +
