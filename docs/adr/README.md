...
This directory contains Architecture Decision Records (ADRs) for the Glassbox project. ADRs capture important architectural decisions and their rationale.
